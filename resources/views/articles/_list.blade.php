<div class="row t-rtcl">
  ...
  <a href="{{ action('ArticlesController@show',[$article->id]) }}" class="col-md-4">
    <figure class="figure p-2 t-rtcl-figure">
      <img data-src="{{ imageView2($article->cover, ['w' => 600,'h' => 300]) }}" src="{{ imageView2(env('SITE_DEFAULT_IMAGE'), ['w' => 600,'h' => 300]) }}" class="figure-img img-fluid lazyload" alt="{{ $article->title }}">
