...
<div class="form-group">
    ...
    <div class="t-edit-area">
        ...
        <div class="card t-editor-card">
            <div class="card-header">封面、描述、标签：</div>
            <div class="card-body">
                <div class="row">
                    <div class="col-md-12 t-edit-cover">
                        <img id="tEditCover" src="{{ imageView2($article->cover, [
                'w' => 600,
                'h' => 300
             ]) }}" alt="">
                        {!! Form::input('file', '', '', ['multiple' => 'multiple', 'accept' => 'image/*', 'id' =>
                        'tCoverFile']) !!}
                        {!! Form::input('hidden', 'cover', null, ['name' => 'cover', 'id' => 'tCover']) !!}
                        <div class="progress">
                            <div id="tCovrProgrs" class="progress-bar progress-bar-striped active" role="progressbar"
                    ...
                    <div class="col-md-12">
                        <div class="form-group">
                            {!! Form::textarea('description', isset($article->description) ? $article->description : '',
                            ['class' => 'form-control t-no-resize t-rtcl-desc', 'maxlength' => '140', 'rows' => '7',
                            'placeholder' => '文章描述']) !!}
                        </div>
